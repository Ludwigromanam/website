...
class Ion_auth
{
	...
	// Retrieve the current time of day for purposes of calculating time stamps	
	public function now()
	{
		$tz = new DateTimeZone("UTC");										// We use UTC for the time zone
		return (new DateTime("now", $tz))->format('Y-m-d H:i:s');	// Return the time in that zone
	}
