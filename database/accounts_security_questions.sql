...
CREATE TABLE `security_questions` (
  ...
  `question` varchar(45) DEFAULT NULL COMMENT 'Text for the question',
  `is_default` varchar(1) NOT NULL DEFAULT 'N' COMMENT 'Is this the default item?',
  PRIMARY KEY (`id`)
...
INSERT INTO `security_questions` VALUES (1,'What is your favorite color?','N'),(2,'What is your pet\'s name?','Y'),(3,'Where did you meet your spouse?','N');
